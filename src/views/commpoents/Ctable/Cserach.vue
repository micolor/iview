        ...
        <Card>
            ...
            <div style="width:80%">
                ...
                <Select v-if="item.type == 'select'" v-model="item.val" :multiple="item.options.multiple"
                    ...
                    <Option v-for="olist in item.options.list" :value="olist.value" :key="olist.value">{{ olist.label
                        }}
                    </Option>
                </Select>
                <DatePicker v-if="item.type == 'daterange'" type="daterange" placement="bottom-end" v-model="item.val"
                            :placeholder="item.placeholder" style="width: 100%"></DatePicker>
            </div>
            </Col>
            ...
            <Row>
                <span @click="handleSearch" style="margin-right: 10px"><Button type="primary" icon="search">搜索</Button></span>
